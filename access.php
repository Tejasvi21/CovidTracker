      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Track Symptons <i class="ion-ios-arrow-forward"></i></span></p>
			            ...
			            <form action="track.php" method="post" id="myForm" autocomplete="off" >
							...
							<div class="d-md-flex">
									<div class="form-group">
										...
										<h6 style="color:black;">Which of the following apply to you?</h6><br>
											<div type="radio">
											  <label><input  type="radio" name="activity" required id="traveledinternationally" value="traveledinternationally">Traveled internationally in the last 14 to 28 days</label>
											</div>
											<div type="radio">
							...
							<div class="d-md-flex">
								<div class="form-group">
										...
										<div class="select-wrap">
											...
											<label for="age">Select your age</label>
											  <select name="age" id="age" required>
												<option value="">Are you above 65 or below 8 years?</option>
									...
									<input type="checkbox" required name="terms"> I confirm that all the given information given by me is true.<br>
